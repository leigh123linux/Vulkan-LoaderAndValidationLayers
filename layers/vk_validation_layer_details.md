...
| Verify Object Not In Use | Validate that object being freed or modified is not in use | OBJECT_INUSE | vkDestroyBuffer vkFreeDescriptorSets vkUpdateDescriptorSets vkDestroySemaphore | SimultaneousUseInUseDestroyedSignaled | This condition is still not tested for the FreeDescriptorSet case |
