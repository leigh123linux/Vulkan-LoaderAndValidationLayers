...
// loader_dispatch_hash_entry and loader_dev_ext_dispatch_table.dev_ext have one
// to one
// correspondence; one loader_dispatch_hash_entry for one dev_ext dispatch entry.
